package dev.darcosse.ultrabeasts.fabric.commands;
...
public class UltraBeastsCommands {
    ...
    private static void registerShinyCommands(CommandDispatcher<ServerCommandSource> dispatcher) {
        dispatcher.register(CommandManager.literal("ultrabeasts")
                .then(CommandManager.literal("reload")
                        ...
                        .executes(UltraBeastsCommands::reloadConfig))
                .then(CommandManager.literal("info")
                        .executes(UltraBeastsCommands::showInfo))
        );
    }
